...
`conferance_id` int(10) NOT NULL,
  ...
  `conference_city` varchar(50) NOT NULL,
...
--
ALTER TABLE `Conferance`
MODIFY `conferance_id` int(10) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `Travel`
MODIFY `travel_id` int(10) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `University`
--
ALTER TABLE `University`
MODIFY `university_id` int(10) NOT NULL AUTO_INCREMENT;
--
